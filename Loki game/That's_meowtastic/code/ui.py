...
class UI:
    ...
    # Creating function for health and energy bars
    ...
    # Creating function for the exp of the player
    ...
    # Creating boxes to display the weapon and magic which is selected
    ...
    # The weapon to be displayed as occupied will be shown by this function
    def weapon_overlay(self, weapon_index, has_switched):
        bg_rect = self.selection_box(10, 630, has_switched) # Box for the weapon
    ...
    def magic_overlay(self, magic_index, has_switched):
        bg_rect = self.selection_box(90, 630, has_switched)  # Box for the magic
