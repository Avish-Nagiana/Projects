...
class Level:
	def __init__(self):
		...
		# Basically getting the display screen from the code
		self.display_surface = pygame.display.get_surface()
		self.game_paused = False

		# sprite group setup
		# Visible sprites are those which will be drawn
		self.visible_sprites = YSortCameraGroup()
		# Obstacle sprites are those with which the player can collide
	...
	def create_map(self):
		# Importing all the layouts and graphics for the map
		layouts = {
		...
		# Going through all the coordinates of the map
	...
	# Function to attack the enemies
	def create_attack(self):
		self.current_attack = Weapon(self.player,
									 [self.visible_sprites,
									  self.attack_sprites])

	# Function to use magic
	...
	# When attack is completed, this is used to remove it
	def destroy_attack(self):
		if self.current_attack:
			self.current_attack.kill()
		self.current_attack = None

	# Logic behind the attack of the player
	...
	# Enabling the damage on the player when attacked by the enemy
	...
	# Function to add exp to the player's
	...
	def run(self):
		...
		if self.game_paused:
			...
			# Creating the visible sprites on the screen
...
class YSortCameraGroup(pygame.sprite.Group):
	...
	def custom_draw(self, player):
		...
		# Rendering sprites relative to the position of the player
